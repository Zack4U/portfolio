...
const TimelineCard: React.FC<TimelineCardProps> = ({ item, index, isLeft, total }) => {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className={`ml-12 md:ml-0 md:w-[calc(100%-20px)] ${
        isLeft ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'
      } relative`}>
        <div className="bg-theme rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 glass">
